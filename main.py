...
import windows3, windows2
from dao import vehicle, usertable, punish, police, driver, notice
...
def Police_Windows1(user):
    ...
    arp2 = tkinter.Label(windows1, text='Created by Dranran~', font=('Arial', 13))
    ...
    btt1 = tkinter.Button(windows1, text='Delete', font=('Arial', 12), command=windows3.delete_windows)
    btt1.place(x=500, y=140)
    btt2 = tkinter.Button(windows1, text='Update', font=('Arial', 12), command=windows3.update_windows)
    btt2.place(x=600, y=140)
    btt3 = tkinter.Button(windows1, text='Insert', font=('Arial', 12), command=windows3.insert_windows)
    ...
    btt5 = tkinter.Button(windows1, text='Delete', font=('Arial', 12), command=windows3.police_delete_windows)
    btt5.place(x=500, y=200)
    btt6 = tkinter.Button(windows1, text='Update', font=('Arial', 12), command=windows3.police_update_windows)
    btt6.place(x=600, y=200)
    btt7 = tkinter.Button(windows1, text='Insert', font=('Arial', 12), command=windows3.police_insert_windows)
    ...
    btt5 = tkinter.Button(windows1, text='Delete', font=('Arial', 12), command=windows3.vehicle_delete_windows)
    btt5.place(x=500, y=260)
    btt6 = tkinter.Button(windows1, text='Update', font=('Arial', 12), command=windows3.vehicle_update_windows)
    btt6.place(x=600, y=260)
    btt7 = tkinter.Button(windows1, text='Insert', font=('Arial', 12), command=windows3.vehicle_insert_windows)
    ...
    btt9 = tkinter.Button(windows1, text='Delete', font=('Arial', 12), command=windows3.punish_delete_windows)
    btt9.place(x=500, y=320)
    btt10 = tkinter.Button(windows1, text='Update', font=('Arial', 12), command=windows3.punish_update_windows)
    btt10.place(x=600, y=320)
    btt11 = tkinter.Button(windows1, text='Insert', font=('Arial', 12), command=windows3.punish_insert_windows)
    ...
    btt13 = tkinter.Button(windows1, text='Delete', font=('Arial', 12), command=windows3.notice_delete_windows)
    btt13.place(x=500, y=380)
    btt14 = tkinter.Button(windows1, text='Update', font=('Arial', 12), command=windows3.notice_update_windows)
    btt14.place(x=600, y=380)
    btt15 = tkinter.Button(windows1, text='Insert', font=('Arial', 12), command=windows3.notice_insert_windows)
    btt15.place(x=700, y=380)
    # Ticket
    ticker = tkinter.Button(windows1, text='Establish', font=('Arial', 12), command=windows2.tuple_funciton)
    ticker.place(x=400, y=440)
    windows1.mainloop()


# Driver_delete()
def Driver_delete(user):
    # Window Configuration
...
def Driver_Windows(user):
    ...
    arp1 = tkinter.Label(windows1, text='Driver_information:', font=('Arial', 13))
    arp1.place(x=200, y=140)
    arp2 = tkinter.Label(windows1, text='Created by Duanran~', font=('Arial', 13))
    arp2.place(x=1000, y=500)
    btt = tkinter.Button(windows1, text='Select', font=('Arial', 12), command=driver.driver)
    btt.place(x=400, y=140)
    windows1.mainloop()
...
if __name__ == '__main__':
    ...
    windows.title('Traffic Violation Management System      (By Duanran~)')
    ...
    tip4 = tkinter.Label(windows, text='Author : duanran@cduanran.com', font=('Arial', 13)).place(x=600, y=430)
    # Entry
    ...
    id1 = tkinter.Radiobutton(windows, text='Police', variable=identity, value=1, font=('Arial', 12)).place(x=450,
                                                                                                            y=280)
    id2 = tkinter.Radiobutton(windows, text='Driver', variable=identity, value=0, font=('Arial', 12)).place(x=550,
                                                                                                            y=280)
    # login Button
